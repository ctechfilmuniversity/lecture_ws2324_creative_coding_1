...
![Alt text](<threeJS/Bildschirmfoto 2023-12-04 um 00.08.57.png>)
...
---
This time I really learned a lot! I took some extra hours to explore different possibilities in  threeJS, as I´m quite fond of 3D graphics in general. The whole process was a bit tedious, and the final outcome looks much worse than what one could do with raytracing for example, but I am really excited about the whole topic, especially the interactive part!
---
.
